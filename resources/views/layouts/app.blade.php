...
<head>
    ...
    <title>@yield('title', 'SSISTEMALED')</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="/dashboard" class="nav-link font-weight-bold">SSISTEMALED</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="/dashboard" class="brand-link text-center">
            <span class="brand-text font-weight-bold">
                <i class="fas fa-lightbulb text-warning mr-1"></i> SSISTEMALED
            </span>
        </a>
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview {{ request()->is('unidades*') || request()->is('responsables*') || request()->is('seguimientos-unidad*') || request()->is('compras*') || request()->is('ventas*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->is('unidades*') || request()->is('responsables*') || request()->is('seguimientos-unidad*') || request()->is('compras*') || request()->is('ventas*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-industry"></i>
                            <p>Unidades Productivas <i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/unidades" class="nav-link {{ request()->is('unidades') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Listar</p>
                                </a>
                            </li>
                            @if(session('usuario_rol') === 'Administrador')
                            <li class="nav-item">
                                <a href="/unidades/create" class="nav-link {{ request()->is('unidades/create') ? 'active' : '' }}">
                                    <i class="far fa-plus-square nav-icon"></i>
                                    <p>Nueva</p>
                                </a>
                            </li>
                            @endif
                            <li class="nav-item">
                                <a href="/responsables" class="nav-link {{ request()->is('responsables*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Responsables</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/seguimientos-unidad" class="nav-link {{ request()->is('seguimientos-unidad*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Seguimientos</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/compras" class="nav-link {{ request()->is('compras*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Compras</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview {{ request()->is('usuarios*') || request()->is('roles*') || request()->is('regiones*') || request()->is('municipios*') || request()->is('categorias*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item has-treeview {{ request()->is('categorias*') ? 'menu-open' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="/categorias/emprendimiento" class="nav-link {{ request()->is('categorias/emprendimiento') ? 'active' : '' }}">
                                            <i class="far fa-dot-circle nav-icon"></i>
                                            <p>Emprendimiento</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/categorias/unidad" class="nav-link {{ request()->is('categorias/unidad') ? 'active' : '' }}">
                                            <i class="far fa-dot-circle nav-icon"></i>
    ...
    <footer class="main-footer text-sm">
        <strong>SSISTEMALED</strong> &copy; {{ date('Y') }} — Sistema de Seguimiento
