...
<form action="/compras" method="POST">
    ...
    <div class="card card-outline card-danger">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-shopping-cart mr-1"></i> Datos de la Compra</h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Costo (Bs) <span class="text-danger">*</span></label>
                        <input type="number" name="costo" value="{{ old('costo') }}" step="0.01"
                               class="form-control @error('costo') is-invalid @enderror" min="0" required>
        ...
        <div class="card-footer">
            ...
            <a href="/compras" class="btn btn-secondary ml-2"><i class="fas fa-times mr-1"></i> Cancelar</a>
        </div>
    </div>
</form>
@endsection
