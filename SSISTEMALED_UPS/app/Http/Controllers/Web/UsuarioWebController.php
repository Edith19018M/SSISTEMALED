...
class UsuarioWebController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('usuarios.create', compact('roles', 'regiones', 'municipios'));
    }
    ...
    public function edit($id)
    {
        ...
        $regiones = Region::orderBy('nombre_region')->get();
        $municipios = Municipio::with('region')->orderBy('nombre_municipio')->get();
        return view('usuarios.edit', compact('usuario', 'roles', 'regiones', 'municipios'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->only(['nombre', 'correo', 'rol_id', 'region_id', 'municipio_id']);
