...
return new class extends Migration
{
    ...
    {
        Schema::create('actividades_emprendimiento', function (Blueprint $table) {
            ...
            $table->foreign('id_compromiso_origen')->references('id_compromiso')->on('compromisos_emprendimiento')->onDelete('set null');
        });
    }
    ...
    {
        Schema::dropIfExists('actividades_emprendimiento');
    }
};
