            ...
            <form method="GET" action="/emprendedores" class="mr-2">
                <div class="input-group input-group-sm">
                    <input type="text" name="busqueda" value="{{ request('busqueda') }}"
                           class="form-control" placeholder="Buscar nombre, CI, código...">
        ...
        <table class="table table-bordered table-striped table-hover mb-0">
            ...
            <tbody>
                @forelse($emprendedores as $emp)
                    <tr>
                        <td><span class="badge badge-warning">{{ $emp->codigo }}</span></td>
                        <td>
                        ...
                        <td>
                            @if($emp->emprendimiento)
                                <a href="/emprendimientos/{{ $emp->emprendimiento->id_emprendimiento }}">
                                    {{ $emp->emprendimiento->nombre }}
                                </a>
                            @else
                        ...
                        <td class="text-right">
                            <a href="/emprendedores/{{ $emp->id_emprendedor }}" class="btn btn-sm btn-outline-info" title="Ver">
