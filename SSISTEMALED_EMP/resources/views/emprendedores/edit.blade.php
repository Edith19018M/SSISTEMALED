...
<form action="/emprendedores/{{ $emprendedor->id_emprendedor }}" method="POST">
    ...
    <div class="card card-outline card-warning">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Código</label>
                        <input type="text" value="{{ $emprendedor->codigo }}" class="form-control" readonly>
                        ...
                        <select name="id_emprendimiento" class="form-control @error('id_emprendimiento') is-invalid @enderror" required>
                            ...
                            @foreach($emprendimientos as $e)
                                <option value="{{ $e->id_emprendimiento }}"
                                    {{ old('id_emprendimiento', $emprendedor->id_emprendimiento) == $e->id_emprendimiento ? 'selected' : '' }}>
                                    {{ $e->nombre }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div class="card-footer">
            ...
            <a href="/emprendedores/{{ $emprendedor->id_emprendedor }}" class="btn btn-secondary ml-2">
