    ...
    <div class="col-md-4">
        ...
        <div class="card card-outline card-warning">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="/emprendedores/create?emprendimiento_id={{ $emprendimiento->id_emprendimiento }}"
                ...
                <ul class="list-group list-group-flush">
                    @forelse($emprendimiento->emprendedores as $emp)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <span class="badge badge-warning mr-1">{{ $emp->codigo }}</span>
                                <strong>{{ $emp->nombre }} {{ $emp->apellidos }}</strong>
                                <br><small class="text-muted">CI: {{ $emp->ci ?? '—' }} | {{ $emp->celular ?? '—' }}</small>
                            </div>
                            <a href="/emprendedores/{{ $emp->id_emprendedor }}" class="btn btn-xs btn-outline-warning">
